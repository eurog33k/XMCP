#tag Class
Protected Class XKWindow
Inherits XKProjectItem
	#tag Method, Flags = &h0
		Sub AddConstant(c As XKConstant)
		  /// Adds a constant to this window.
	...
	#tag Method, Flags = &h0
		Sub AddControlEventGroup(ceg As XKControlEventGroup)
		  /// Adds a control event group to this window.
	...
	#tag Method, Flags = &h0
		Sub AddProperty(p As XKProperty)
		  /// Adds a property to this window.
	...
	#tag Method, Flags = &h0
		Sub AddViewProperty(vp As XKViewProperty)
		  /// Adds a view property to this window.
	...
	#tag Method, Flags = &h0
		Sub ClearControls()
		  /// Clears all controls from this window.
	...
	#tag Method, Flags = &h0
		Sub Constructor(parent As XKNode = Nil)
		  /// Creates a new window with the specified parent.
	...
	#tag Method, Flags = &h0
		Function ControlEventGroups() As XKControlEventGroup()
		  /// Returns all control event groups in this window.
	...
	#tag Method, Flags = &h0
		Function Controls() As XKControl()
		  /// Returns all top-level controls in this window.
	...
	#tag Method, Flags = &h0
		Function Events() As XKEvent()
		  /// Returns all events in this window.
	...
	#tag Method, Flags = &h0
		Function GetAttribute(key As String, defaultValue As String = "") As String
		  /// Gets a window attribute by its key.
	...
	#tag Method, Flags = &h0
		Function Methods() As XKMethod()
		  /// Returns all methods in this window.
	...
	#tag Method, Flags = &h0
		Function Properties() As XKProperty()
		  /// Returns all properties of this window.
	...
	#tag Method, Flags = &h0
		Function ViewProperties() As XKViewProperty()
		  /// Returns all view behavior properties in this window.
