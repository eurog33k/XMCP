	...
	#tag Method, Flags = &h0
		Function Run(args() As MCPKit.ToolArgument) As MCPKit.ToolResult
		  ...
		  If logFile = Nil Or Not logFile.Exists Then
		    Return MCPKit.ToolResult.Success("No debug log found at " + Platform.DebugLogPath + ". Make sure the app has an App.UnhandledException handler that writes to this path.")
		  End If
		  ...
		  Catch e As IOException
		    Return MCPKit.ToolResult.Failure("Failed to read " + Platform.DebugLogPath + ": " + e.Message)
		  End Try
